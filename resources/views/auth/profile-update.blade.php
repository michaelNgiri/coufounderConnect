            ...
            <div class="card">
                ...
                <div class="card-body" style="text-align: center;">
                   ...
                   <span><b>Name:</b><input type="text" name="" placeholder="{{Auth::user()->name()}}"></span>
                    ...
                    <span><b>Street Address:</b><input type="text" name="" placeholder="{{Auth::user()->Address}}"></span>
                    ...
                    <span><b>Availability:</b>
                        <select name="availability" id="availability" class="selectpicker" data-live-search="true">
                            <option value="10hrs">10hrs/week</option>
                            <option value="20hrs">20hrs/week</option>
                            <option value="30hrs">30hrs/week</option>
                            <option value="40hrs">40hrs/week</option>
                            <option value="above40">>40hrs/week</option>
                        </select>
